...
public class ElasticSearchTransportClient implements ElasticSearchClient {
    ...
    public void addEvent(Event event, IndexNameBuilder indexNameBuilder,
        ...
        if (indexRequestBuilderFactory == null) {
        	//logger.info("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
        	//logger.info("indexNamebulider   "+ indexNameBuilder.getIndexName(event));
        	//logger.info("prepareIndex   " + client.prepareIndex(indexNameBuilder.getIndexName(event), indexType));
        	//logger.info("11111111111111111111111111111111111111111111111");
        	//logger.info(serializer.getContentBuilder(event).toString());
        	//logger.info("33333333333333333333333333333333333333333333333");
        	//logger.info("serializer" + serializer.getContentBuilder(event).bytes());
        	//logger.info("２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２２");
